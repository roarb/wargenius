...
var masterUnit = new Array ();
	...
	masterUnit['flammable'] = (0); // flammable double wounds caused by flaming attacks
	masterUnit['flameWard'] = (0); // 2 up ward vs fire
	masterUnit['frostAura'] = (0); // not sure what this does
